        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="sno" lay-verify="required|account" placeholder="用户名或者邮箱" autocomplete="off" class="layui-input" value="180203111">
                </div>
                <div class="layui-form-item">
               ...
               <%-- <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="${pageContext.request.contextPath}/statics/layui/images/captcha.jpg">
                    </div>
                </div>--%>
                <%--<div class="layui-form-item">
